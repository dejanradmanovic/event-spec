...
func (h *Handler) routes() {
	...
	h.mux.HandleFunc("GET /ui/settings/apps", h.withSession(RoleAdmin, h.handleAppList))
	h.mux.HandleFunc("GET /ui/settings/apps/new", h.withSession(RoleAdmin, h.handleNewAppForm))
	h.mux.HandleFunc("POST /ui/settings/apps/new", h.withSession(RoleAdmin, h.handleCreateApp))
	h.mux.HandleFunc("GET /ui/settings/apps/{name}", h.withSession(RoleAdmin, h.handleAppDetail))
	h.mux.HandleFunc("GET /ui/settings/apps/{name}/edit", h.withSession(RoleAdmin, h.handleEditAppForm))
	h.mux.HandleFunc("POST /ui/settings/apps/{name}/edit", h.withSession(RoleAdmin, h.handleUpdateApp))
	h.mux.HandleFunc("DELETE /ui/settings/apps/{name}", h.withSession(RoleAdmin, h.handleDeleteApp))
