...
mavenPublishing {
  ...
  coordinates("io.event-spec", "kotlin-provider-event-spec", version.toString())

  pom {
    name = "event-spec Kotlin Server Provider"
    description =
        "Thin-client analytics provider for event-spec — forwards events to the event-spec runtime ingestion server over HTTP"
